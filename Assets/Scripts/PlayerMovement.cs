...
public class PlayerMovement : MonoBehaviour
{
    ...
    public string[] passTags = { "Enemy01", "Enemy02",  "EnemyProjectile" };
    ...
    void InputHandler()
    {
        ...
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            else if (Input.GetKey(KeyCode.M) && timer <= 0)
            {
                timer = rateOfFire;
                Fire(true);
            }
    ...
    void Bomb()
    {
        ...
        {
            GameObject[] gwt = GameObject.FindGameObjectsWithTag(passTags[i]);
